    ...
    <div className="footer">
      ...
      <div className="footer-center">
        <div className="footer-center-btn">
          ...
          <button className="btn" onClick={() => openExt('https://www.linkedin.com/in/braven-chiambucket/')} aria-label="LinkedIn">
            <svg width="27" height="27" fill="#0A66C2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
